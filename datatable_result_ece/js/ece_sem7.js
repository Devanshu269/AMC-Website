...
$(document).ready(function() {
    ...
    var table = $('#user_data').DataTable({
        ...
        columns: [
            ...
            { data: sub1, title: 'Computer networks' },
            { data: sub2, title: 'VLSI design' },
            ...
            { data: sub7, title: 'Computer networks Laboratory' },
            { data: sub8, title: 'VLSI Laboratory' },
        ],
        dom: 'Bfrtip',
        orderCellsTop: true,
        fixedHeader: true,
    ...
    firebase.database().ref('Result/Sem7/ECE/IA1').on('child_added', function(snapshot) {
        dataSet = [USN = snapshot.val().USN, Name = snapshot.val().Name, Student_Section = snapshot.val().Section, sub1 = snapshot.val().Computer_networks,
            sub2 = snapshot.val().VLSI_design,sub3 = snapshot.val().Open_elective_B,
            sub4 = snapshot.val().Professional_elective_II,sub5 = snapshot.val().Professional_elective_III,
            sub6 = snapshot.val().Project_work_phase_I, sub7 = snapshot.val().Computer_network_Laboratory,
            sub8 = snapshot.val().VLSI_Laboratory];
...
$(document).ready(function() {
    ...
    firebase.database().ref('Result/Sem7/ECE/IA2').on('child_added', function(snapshot) {
        dataSet = [USN = snapshot.val().USN, Name = snapshot.val().Name, Student_Section = snapshot.val().Section, sub1 = snapshot.val().Computer_networks,
            sub2 = snapshot.val().VLSI_design,sub3 = snapshot.val().Open_elective_B,
            sub4 = snapshot.val().Professional_elective_II,sub5 = snapshot.val().Professional_elective_III,
            sub6 = snapshot.val().Project_work_phase_I,sub7 = snapshot.val().Computer_network_Laboratory,
...
$(document).ready(function() {
    ...
    firebase.database().ref('Result/Sem7/ECE/IA3').on('child_added', function(snapshot) {
        dataSet = [USN = snapshot.val().USN, Name = snapshot.val().Name, Student_Section = snapshot.val().Section, sub1 = snapshot.val().Computer_networks,
            sub2 = snapshot.val().VLSI_design,sub3 = snapshot.val().Open_elective_B,
            sub4 = snapshot.val().Professional_elective_II,sub5 = snapshot.val().Professional_elective_III,
            sub6 = snapshot.val().Project_work_phase_I, sub7 = snapshot.val().Computer_network_Laboratory,
