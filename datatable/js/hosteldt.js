...
$(document).ready(function() {
    ...
    var table = $('#user_data').DataTable({
        ...
        columns: [
            ...
            { data: Student_Section, title: 'Boys/Girl'},
            { data: sem, title: 'SEM' },
            { data: StudentRoom, title: 'Student Room No'},
            { data: SharingType, title: 'Sharing Type'},
            { data: ReciptNO, title: 'Receipt No' },
            { data: Tp, title: 'Fee Paid' },
    ...
    firebase.database().ref('Hostel').on('child_added', function(snapshot) {
        var dataSet = [USN = snapshot.val().USN, Program = snapshot.val().Branch, Student_Section = snapshot.val().Hostel_Type, sem = snapshot.val().SEM, StudentRoom = snapshot.val().Student_RoomNo, SharingType = snapshot.val().Room_sharing, ReciptNO = snapshot.val().Hostel_ReciptNo, Tp = snapshot.val().Paid_amount, PD = snapshot.val().Paid_date];
